...
public class PlayerController : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        m_playerActions.Player1_map1.Interact.performed += InteractAction;
    }
    ...
    void Update()
    {
        ...
        float playerMoveX = m_playerActions.Player1_map1.Move.ReadValue<Vector2>().x;
        float playerMoveY = m_playerActions.Player1_map1.Move.ReadValue<Vector2>().y;
